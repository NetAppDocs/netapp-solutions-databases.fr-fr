...
summary: 'L"agilité du cloud public, le délai de rentabilisation et les économies sont autant d"arguments de valeur significatifs pour les entreprises qui adoptent le cloud public pour le développement d"applications de base de données et les efforts de test.' 
