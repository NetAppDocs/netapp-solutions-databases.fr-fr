...
link:https://www.netapp.com/pdf.html?item=/media/16865-tr-4467.pdf["TR-4467 : SAP avec Microsoft SQL Server sous Windows – Bonnes pratiques avec NetApp Clustered Data ONTAP et SnapCenter"^]
