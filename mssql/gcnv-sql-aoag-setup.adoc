...
----
+
Pour connaître les exigences détaillées en matière de pare-feu, veuillez vous référer à link:https://learn.microsoft.com/en-us/troubleshoot/windows-server/networking/service-overview-and-network-port-requirements["Exigences relatives aux services et aux ports réseau de Windows Server"^].
