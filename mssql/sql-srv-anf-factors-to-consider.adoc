...
summary: 'Cette section décrit les différents points à prendre en compte lors de l"utilisation d"Azure NetApp Files avec SQL Server dans le cloud.' 
---
...
* Les chemins UNC suivants sont pris en charge :  `\\ANFSMB-b4ca.anf.test\SQLDB` et  `\\ANFSMB-b4ca.anf.test\SQLDB\`.
