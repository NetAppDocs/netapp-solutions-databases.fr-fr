...
* Utilisez un module AWR d'analyseur HTML pour récupérer les informations de dimensionnement d'une base de données Oracle actuelle à partir d'un rapport AWR.
